...
public class CardBoardActivity extends Activity {
    private static final String TAG = CardBoardActivity.class.getSimpleName();
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    CardBoardActivity.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
